...
RECOMP_PATCH void Environment_UpdateTimeBasedSequence(PlayState* play) {
    s32 pad;
    ...
    // @mod Don't play final hours until it's actually past midnight
...
s32 func_800B7298(PlayState* play, Actor* csActor, u8 csAction); // Player_SetCsActionWithHaltedActors
...
RECOMP_PATCH void EnTest6_DoubleSoTCutscene(EnTest6* this, PlayState* play) {
